...
“Your Git is correctly set up for Windows, supports large files, handles SSL securely, and auto-fixes line endings.”


To get back to normal prompt just press in keyboard:
